...
cards=[
("💰 Revenue",f"${total_sales:,.0f}","#22C55E"),
("📈 Profit",f"${total_profit:,.0f}","#3B82F6"),
("📦 Orders",f"{total_orders}","#F59E0B"),
("🛒 Avg Sales",f"${avg_sales:.2f}","#A855F7")
]
...
<b>Python • Streamlit • FastAPI • Plotly • Pandas</b>
